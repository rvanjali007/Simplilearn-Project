...
public class First_Project1 {
	...
	public static void main(String[] args) {
		...
		char ch;
		File directory = new
		File("C:\\Users\\Public\\FirstSimplilearnProject");
		...
		System.out.println();
		do {
		System.out.println("Select File Option to perform anyoperation:- \n");
		...
		try {
		File file = new
		File("C:\\Users\\Public\\FirstSimplilearnProject\\" + filename + ".txt");
		...
		if
		(delete_filename.equalsIgnoreCase(filename)) {
		File file = new File("C:\\Users\\Public\\FirstSimplilearnProject\\" + delete_filename);
		if (file.delete()) {
		...
		filename = input.next();
		File directory_search = new File("C:\\Users\\Public\\FirstSimplilearnProject\\");
	   ...
	   File folder = new File("C:\\Users\\Public\\FirstSimplilearnProject\\");
